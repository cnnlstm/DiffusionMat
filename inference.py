...
def parse_args_and_config():
    ...
    parser.add_argument('--repeat_step', type=int, default=0, help='repeat sampling steps')
    

    parser.add_argument('--warmup_step', type=int, default=5000, help='warmup steps for training')
    parser.add_argument('--total_step', type=int, default=100000, help='total steps for training')
